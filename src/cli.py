...
from src.agent import MemePyAgent
...
class MemePyCLI:
    def __init__(self):
        ...
        self.config_dir = Path.home() / '.MemePy'
    ...
    def _initialize_commands(self) -> None:
        ...
        self._register_command(
            Command(
                name="exit",
                description="Exits the MemePy CLI.",
    ...
    def _get_prompt_message(self) -> HTML:
        ...
        return HTML(f'<prompt>MemePy-CLI</prompt> {agent_status} > ')
    ...
    def _print_welcome_message(self) -> None:
        ...
        print_h_bar()
        logger.info("👋 Welcome to the MemePy CLI!")
    ...
    def _load_agent_from_file(self, agent_name):
        try: 
            self.agent = MemePyAgent(agent_name)
